package com.vivid.akka.simpleStart.myCluster;
...
import static com.vivid.akka.simpleStart.myCluster.TransformationMessages.BACKEND_REGISTRATION;

/**
 * 
 * @author luoxin
 * @Time 创建时间：2018年1月11日 下午2:16:09
 * @Version
 */
public class MyAkkaClusterClient extends UntypedActor {
	...
	public void onReceive(Object message) {
		if ((message instanceof TransformationMessages.TransformationJob) && backends.isEmpty()) {// 无服务提供者
			...
			getSender().tell(new TransformationMessages.JobFailed("Service unavailable, try again later", job),
					getSender());
	...
	public static void main(String[] args) {
		...
		final ActorRef myAkkaClusterClient = actorSystem.actorOf(Props.create(MyAkkaClusterClient.class),
				"myAkkaClusterClient");
