...
* 
* @author luoxin
* @Time 创建时间：2018年1月11日 下午2:14:08 
* @Version 
*/
...
public class MyAkkaClusterServer extends UntypedActor {
	...
	void register(Member member) {
		if (member.hasRole("client"))
			getContext().actorSelection(member.address() + "/user/myAkkaClusterClient").tell(BACKEND_REGISTRATION,
					getSelf());
		System.out.println("-----"+member.address() + "/user/myAkkaClusterClient");
	}
